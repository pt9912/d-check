...
**pfad:** `docs/plan/planning/open/slice-074-kommentar-suffix-tabellenzeilen.md:30`,
...
**verifizierbar:** ja — `grep -n "Suffix" docs/plan/planning/open/slice-074-kommentar-suffix-tabellenzeilen.md`
