...
**pfad:** `docs/plan/planning/done/slice-074-kommentar-suffix-tabellenzeilen.md:52-53`
...
**verifizierbar:** ja — `grep -n "Splitter" docs/plan/planning/done/slice-074-kommentar-suffix-tabellenzeilen.md`
