...
| [slice-116](done/slice-116-adr-neuzugangs-regel.md) | ADR-Neuzugangs-Regel + Erstanwendung: die beiden `Proposed`-ADRs ziehen `Schärft:`/`Bezug:` auf Kennungen, Slice-Kopf-Feld „Berührte Spec-Stellen" nutzt Kennungen, Reviewer-Anker | ADR-Index, `.harness/skills/reviewer.md` |
