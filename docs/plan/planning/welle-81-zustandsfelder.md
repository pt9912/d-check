...
| [slice-118](in-progress/slice-118-zustandsfeld-regel.md) | Die Regel verkörpern, bevor sie angewandt wird: Briefing-Hard-Rule auf Zustandsfelder erweitert, Reviewer-Skill mit dem HIGH-Anker | [`MR-000`](../../../harness/conventions.md#mr-000--baseline-aussage), Reviewer-Skill |
