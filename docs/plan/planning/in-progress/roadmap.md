...
(Feature-Paar `--doctor`/`--repair`) und welle-16 (E2E) im **Release
v0.12.0 vorbereitet** (CHANGELOG-Sektion 0.12.0 geschlossen); Push + Tag
`v0.12.0` + GHCR-Digest-Pin folgen (Nutzer-Flow), der Digest-Pin wird in
den Welle-Zeilen nachgetragen. Die nächste Welle wartet auf ihren Trigger
