...
**welle-65-handbuch-aufgaben** — §4 des Benutzerhandbuchs auf Aufgabenorientierung
umstellen (Benutzerhandbuch-Standard §2/§5). [`slice-072`](slice-072-handbuch-aufgabenorientierung.md)
(B-1…B-8: §4.4/§4.5/§4.7/§4.11 auf Ziel-Titel + Lesersituation, der große §4.12
aufgetrennt; **reine Doku**, kein Release/ADR).
...
(slice-072 ist mit welle-65 aktiv).
...
| 2026-07-19 | **welle-63-sources eröffnet**; slice-080 in `in-progress/` angelegt (WIP-Slot frei nach welle-62) | §4-Vorfragen (Nutzer) entschieden: Pin-Deklaration **beides** (Marker + Config), Quelltypen **Einzeldatei + Archiv** (`unpack: zip`); der `pins`/dpin-Hash-Ergonomie-Fix bleibt separat ([`slice-072`](../in-progress/slice-072-handbuch-aufgabenorientierung.md)). Anlass: Nutzer-Frage „Drift gegen Upstream in d-check einbauen" — produktisiert `check_regelwerk_drift.py` als reusables Modul [`DC-FA-SRC-001`](../../../../spec/lastenheft.md#dc-fa-src-001--upstream-content-drift-externer-quellen-modul-sources-opt-in-netz), erweitert [`DC-QA-03`](../../../../spec/lastenheft.md#dc-qa-03--seiteneffektfreiheit-und-netzwerk-sparsamkeit) um eine zweite Netz-Tür |
