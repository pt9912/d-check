...
Terminen (siehe [Baseline-Regelwerk `modul-06-roadmap.md`](../../../../.harness/baseline/v6.9.0/regelwerk/modul-06-roadmap.md)).
...
§Roadmap-Struktur (v6.9.0): *Offene Wellen* trägt **zwei unabhängige
