...
- [ ] **ADR:** Begründung der Zwei-Feld-Semantik gegen die Negations-Syntax und
  des Alias-Pfads.
- [ ] **Spezifikation-`.a`:** Auflösungs-Semantik, Präzedenz gegenüber
  `scan.ignore` und dem Zeilen-Marker, Verhalten bei leerem `refs`.
