...
[`modul-06-roadmap.md`](../../../../.harness/baseline/v6.9.0/regelwerk/modul-06-roadmap.md)
...
Slice-Planung (Sichtungs-Schritt darunter, im Abschnitt der **vorgelagerten Prüfungen** jedes Slice-Plans — Baseline-Form `v6.9.0` §8, Haus-Form des eingefrorenen Bestands §7).
