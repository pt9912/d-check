...
[welle-86](welle-86/welle-86-closure-uebergang-durchsetzen.md); dort ist die
...
2. **Sie ist kein Gate.** Eingespeister Text ist Kontext, keine erzwungene
   ...
   [welle-86](welle-86/welle-86-closure-uebergang-durchsetzen.md); daran ändert diese
   Zustellung nichts.
...
[welle-86](welle-86/welle-86-closure-uebergang-durchsetzen.md) §4 schrieb „der
