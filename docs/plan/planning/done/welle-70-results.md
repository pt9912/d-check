...
- **Bestandsmessung vor Varianten-Entscheid** hat sich zum zweiten Mal getragen
  ...
  [slice-103](../open/slice-103-geteilte-lexik-raender.md) übernommen.
...
- [slice-103](../open/slice-103-geteilte-lexik-raender.md) — dieselbe Klasse in
...
- [slice-099](../in-progress/slice-099-structure-modul.md) — der Trigger der
