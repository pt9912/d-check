...
(Lint-Profil als Konsequenz), [`ADR-0006`](../../adr/0006-lint-profil-solid.md) (entsteht in diesem Slice);
...
Ausnahmen), beschlossen als [`ADR-0006`](../../adr/0006-lint-profil-solid.md); der Code ist ohne
Inline-Suppressions lint-clean.

## 2. Definition of Done

- [x] [`ADR-0006`](../../adr/0006-lint-profil-solid.md) `Accepted` (min. 3 Alternativen; Abweichung vom
  Vorbild begründet: kein `depguard` — Architektur-Regeln bleiben in
  der [`ADR-0005`](../../adr/0005-modul-layout-hexagon-ordner.md)-Fitness-Function `tools/arch-check.sh`).
...
|---|---|---|
| `docs/plan/adr/0006-lint-profil-solid.md` | neu | Profil-Entscheidung (Vorbild: u-boot-[`ADR-0003`](../../adr/0003-config-format.md)) |
...
**Umsetzung:** Commit `33e2cd5` ([`ADR-0006`](../../adr/0006-lint-profil-solid.md), Profil, Refactorings,
Doku-Nachzug).
