...
[`slice-064`](welle-53/slice-064-gate-consistency-tombstone.md), Reihenfolge offen).
...
- **Reihenfolge zu [`slice-064`](welle-53/slice-064-gate-consistency-tombstone.md):** beide
