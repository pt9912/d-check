...
- **Zwei Folge-Slices geschnitten und angelegt:**
  ...
  [slice-101](../open/slice-101-fence-unbalanciert.md).
...
- [slice-101](../open/slice-101-fence-unbalanciert.md) — der ausgelieferte stille
...
- [slice-094](../open/slice-094-closure-zaehl-paritaet.md),
  ...
  [slice-098](../open/slice-098-closure-note-placeholder.md) — bleiben
