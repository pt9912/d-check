...
- Nach Abschluss erhält der Slice in `done/` seine Closure-Notiz
  (Abschnitt *Closure-Notiz* des Slice-Plans) mit dem Commit-Hash der Umsetzung. Der
  **Steering-Loop-Eintrag** der Closure-Notiz verweist auf die kanonische
  Definition im vendorten Regelwerk:
  [`grundlagen-klassifikation.md` §Steering Loop](../../../.harness/baseline/v6.6.0/regelwerk/grundlagen-klassifikation.md#steering-loop).
