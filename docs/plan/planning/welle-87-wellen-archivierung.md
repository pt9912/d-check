...
| Slice | Titel | Bezug |
|---|---|---|
| [slice-190](open/slice-190-wellen-archiv-werkzeug.md) | Archivierungs-Werkzeug bauen (Sammeln, ZIP, Stubs, Verweis-Nachzug), verifiziert an einem Fixture | `modul-06-roadmap.md` §Wellen-Closure-Prozedur, Schritt 4 |
