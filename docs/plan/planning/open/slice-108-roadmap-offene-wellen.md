...
- [ ] Roadmap in v5.6.0-Form, `make planning-check`/`make gates` grün (beide
      Profile), Marker-Wächter belegt (Negativ-Probe: Marker bei belegtem
      `in-progress/` ⇒ rot).
- [ ] [`MR-024`](../../../../harness/conventions.md#mr-024--aktuelle-welle-ruhe-marker-im-wellenlosen-zustand-aktive-welle-template-konform)-Entscheid vollzogen und im Index nachvollziehbar.
- [ ] Kein Produkt-Code berührt; unabhängiger Review.
