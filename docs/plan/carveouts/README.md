...
| --- | --- | --- | --- |
| [CO-001](CO-001-vcs-range-stiller-skip.md) | `vcs --range` überspringt still, solange das publizierte Image den Fix nicht trägt | `adr-check` | Klassen-Fix `slice-220`, Release `v0.76.1` (`slice-219`) |
