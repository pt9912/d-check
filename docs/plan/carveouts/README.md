...
| [CO-002](CO-002-slice-221-gegenstand-entfallen.md) | `slice-221` schließt ohne Lieferung — der DoD-Wächter kennt den `Gegenstand:`-Ausgang noch nicht | `verify-closure-notes` | [slice-225](../planning/open/slice-225-gegenstand-entfallen-uebernommen.md) geschlossen |
