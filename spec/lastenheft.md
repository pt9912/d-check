...
|---|---|---|---|
| 0.65.4 | 2026-08-23 | **Form eines Verweises, keine Anforderungs-Änderung.** Eine Historie-Zeile nannte eine Kennung der zeitlichen Schicht und war damit ein Abwärtsverweis, den §3.4 verbietet; die Aussage bleibt unverändert, der Verweis ist aufgelöst. Sichtbar wurde sie erst, als die Referenzmatrix eine Klasse für diese Schicht bekam — bis dahin fehlte schlicht der Wächter, der sie melden konnte. **Kein Protokoll-Eingriff im Sinne des Kanons:** geändert ist die **Form** eines Verweises, nicht die berichtete Tatsache | — |
