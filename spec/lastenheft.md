...
| `exempt-expect-count` (int ≥ 0; nur mit `exempt-section-pattern`) | `section-exempt-mismatch` | Aufzählung oder Zahl nachziehen |
...
nachgezogene Zahl ist dieselbe Lücke wie eine veraltete. Der eigene Grund-Code
ist Pflicht, weil die Reparatur eine andere ist — *Aufzählung oder Zahl
nachziehen* statt *Selektor korrigieren*.
