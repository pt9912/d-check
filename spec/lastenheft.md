...
|---|---|---|---|
| 1/2 | **`mode: one`** (Default): der Aktiv-Status-Abschnitt nennt eine Welle ⟺ **genau ein** flaches Wellendokument existiert (Ruhe-Marker ⟺ **keines**) · **`mode: many`**: die im Aktiv-Status-Abschnitt genannte **Kennungs-Menge** ist gleich der Menge der flachen Wellendokumente — beide Richtungen, jede Kardinalität, der Ruhe-Marker geht **nicht** ein | `wave-drift` | Roadmap nachziehen **oder** Datei verschieben |
...
Ruhe-Marker steht — verglichen wird gegen **genau ein** flaches Dokument. Im
