...
[`modul-03-spec.md` §Ziel-Form: Spezifikation](../.harness/baseline/v6.5.0/regelwerk/modul-03-spec.md#ziel-form-spezifikation).
...
2. **Geänderte Kandidaten.** Aus dem Diff `BASE..HEAD` (bzw. staged) werden die
   ...
   **BASE-Stand gar nicht lesen konnte** — dann sähe der Schritt eine freie
   ...
   Gitlink) ist dabei kein unlesbares Objekt, sondern bleibt befundfrei.
