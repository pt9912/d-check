...
[`modul-03-spec.md` §Ziel-Form: Spezifikation](../.harness/baseline/v5.12.0/regelwerk/modul-03-spec.md#ziel-form-spezifikation).
...
5. Dreizehn `.PHONY`-Targets, jeweils mit `##`-Annotation (die das `help` des
   ...
   - `doc-usage` (`--help`,
     ...
     Target exponiert einen **Modus**, kein Regelmodul, und trägt deshalb als
     einziges der dreizehn **keine** `--enable`/`--disable`-Wahl. Das Recipe ist
