...
<!-- Quelle: [00-einfuehrung/modul-00-einfuehrung.md](https://github.com/pt9912/ai-harness-course/blob/v5.12.0/kurs/de/00-einfuehrung/modul-00-einfuehrung.md) -->
...
- In den dokumentierten Scheiterfällen war meist nicht das Modell die Ursache, sondern eine Spec-Lücke oder ein fehlender Sensor. Das Modell rät, *weil nichts in der Eingabe widerspricht*. Lopopolo (OpenAI 2026) und die dokumentierten Repo-Fallstudien belegen das.
