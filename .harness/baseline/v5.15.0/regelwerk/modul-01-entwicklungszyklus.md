...
<!-- Quelle: [01-spec-und-architektur/modul-01-entwicklungszyklus.md](https://github.com/pt9912/ai-harness-course/blob/v5.15.0/kurs/de/01-spec-und-architektur/modul-01-entwicklungszyklus.md) -->
...
flowchart LR
    ...
    Harness["AGENTS.md · Gate · Skill · MR<br/>(verkörperte Regel)"]
