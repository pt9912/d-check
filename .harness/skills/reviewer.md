...
[`modul-10` §Ziel-Form](../baseline/v6.6.0/regelwerk/modul-10-review-harness.md)
...
- **HIGH** (blockiert Merge): Stilles-Grün-Pfad in einem Gate oder   <!-- d-check:cite AGENTS.md:412-413 -->
  ...
  [`modul-10` §Finding-Kategorien](../baseline/v6.6.0/regelwerk/modul-10-review-harness.md):
  ...
  **ein** auflösbares Feld zulässig
  ([Baseline §Was ein Kommentar trägt](../baseline/v6.6.0/regelwerk/grundlagen-harness-dateien.md#was-ein-kommentar-trägt--code-konfiguration-skripte);
...
- **MEDIUM** (vor Merge zu klären): Spec-Treue-Lücke einer
  ...
  *zeigt* sie, wo verifiziert/entstanden (Provenance, ok), oder *begründet* sie
  ...
  [§Referenz-Richtung (SDP)](../baseline/v6.6.0/regelwerk/grundlagen-referenz-richtung.md#referenz-richtung-sdp-wer-darf-wen-referenzieren).
...
<!-- d-check:cite .harness/baseline/v6.6.0/regelwerk/modul-10-review-harness.md:82-82 -->
