...
Das Gate prüft **Struktur**, dieser Skill prüft **Inhalt vs. Floskel**. Der   <!-- d-check:cite .harness/baseline/v5.15.0/regelwerk/modul-11-verification.md:64-64 -->
...
<!-- d-check:cite .harness/baseline/v5.15.0/templates/.harness/skills/closure-note-reviewer.template.md:83-83 -->
