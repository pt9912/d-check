...
Das Gate prüft **Struktur**, dieser Skill prüft **Inhalt vs. Floskel**. Der   <!-- d-check:cite .harness/baseline/v6.9.0/regelwerk/modul-11-verification.md:83-83 -->
...
<!-- d-check:cite .harness/baseline/v6.9.0/templates/.harness/skills/closure-note-reviewer.template.md:83-83 -->
