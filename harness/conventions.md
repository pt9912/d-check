...
| [MR-013](conventions/done/MR-013-lifecycle-move-buendelung.md) <a id="mr-013--lifecycle-move-commit-bündelt-gekoppelte-verweise"></a><a id="mr-013"></a> | Baseline-Konformität (seit slice-223, in zwei Schritten am selben Tag): Slice-Lifecycle-Hälfte reine Git-Semantik, MR-/Wellen-Hälfte durch Review-Korrektur — der lokale Hook prüft den Arbeitsbaum, nicht den Commit-Diff, ein reiner Move ist deshalb committierbar |
