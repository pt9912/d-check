...
| [MR-049](conventions/MR-049-ausgangs-wortschatz.md) <a id="mr-049--der-ausgang-eines-risikos-trägt-eines-der-drei-wörter-schärft-mr-006"></a><a id="mr-049"></a> | Geschlossener Ausgangs-Wortschatz, gewächtert im Closure-Profil (schärft [`MR-006`](conventions.md#mr-006)) | `.d-check.closure.yml`, §5 der `done/`-Slices | keine — Werkzeug-Wahl für die urteilsfreie Hälfte, die der Kanon dem Repo überlässt |
