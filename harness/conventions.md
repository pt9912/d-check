...
| [MR-066](conventions/MR-066-slice-wachstum-ohne-rueckfuehrung.md) <a id="mr-066--wird-die-rückführung-nicht-gezogen-wird-die-review-last-geteilt-statt-des-slice"></a><a id="mr-066"></a> | Wird die Rückführung nicht gezogen, wird die **Review-Last** geteilt statt des Slice (seit slice-204) | jeder Slice über der Ein-Sitzungs-Review-Grenze, der nicht zurückgeführt wird | keine — ergänzt `modul-05` §Trigger je Lifecycle-Übergang um den Fall, dass der Rückführung etwas entgegensteht |
