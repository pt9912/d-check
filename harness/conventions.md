...
- **Lokale Lese-Form (materialisiert):** das entpackte **Regelwerk**-Bundle
  unter `.harness/cache/<tag>/regelwerk/` als Lese-Form; das **Template**-Set
  unter `.harness/cache/<tag>/templates/` nur als Adoptions-/Drift-Audit-Staging
  (nicht Autorenquelle —
  [`MR-018`](#mr-018--d-check-verkörpert-als-producer-self-hoster-keine-templates)).
  Beide gitignored, aus dem Selbst-Scan ausgenommen; Cache-Konvention siehe
