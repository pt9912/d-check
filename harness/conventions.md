...
- **Stand:** [`v6.9.0`](https://github.com/pt9912/ai-harness-course/releases/tag/v6.9.0),
  gepinnt mit
  [`MR-072`](#mr-072)
...
- **Extern (Lehrmaterial):**
  [`ai-harness-course@v6.9.0`](https://github.com/pt9912/ai-harness-course/tree/v6.9.0)
...
- **Vendored Baseline (Regelwerk + Templates):** aus dem self-contained
  ...
  entpackt nach [`.harness/baseline/v6.9.0/`](../.harness/baseline/v6.9.0/regelwerk/)
...
([Baseline-Regelwerk §Konventionsspeicher](../.harness/baseline/v6.9.0/regelwerk/grundlagen-harness-dateien.md#harnessconventionsmd-als-konventionsspeicher)).
...
| [MR-013](conventions/MR-013-lifecycle-move-buendelung.md) <a id="mr-013--lifecycle-move-commit-bündelt-gekoppelte-verweise"></a><a id="mr-013"></a> | Lifecycle-Move-Commit bündelt Verweise (getrimmt seit slice-223 — nur noch MR-/Wellen-Moves) | MR-/Wellen-Lifecycle-Moves (`conventions/` → `conventions/done/`, flaches Wellendokument → `done/`) | keine — `AGENTS.template.md` §3.3 deckt die Slice-Lifecycle-Hälfte inzwischen selbst; Geltungsbereich siehe `Ersetzt-Baseline-Regel` im Eintrag |
...
| [MR-050](conventions/MR-050-herkunfts-anker-ist-kein-verweis.md) <a id="mr-050--der-herkunfts-anker-einer-hard-rule-ist-kein-slice-verweis-schärft-mr-045"></a><a id="mr-050"></a> | Herkunfts-Anker `(seit slice-<NNN>)` ist von [`[MR-045](#mr-045)`](conventions.md#mr-045) ausgenommen (schärft ihn) | `AGENTS.md`, `harness/README.md` | keine — stellt die Baseline-Vorgabe wieder her, die der Vorgänger zu breit gefasst hatte |
| [MR-051](conventions/MR-051-cite-spannen-beim-bump.md) <a id="mr-051--ein-baseline-bump-ankert-die-d-checkcite-spannen-neu-nachtrag-zu-mr-021"></a><a id="mr-051"></a> | Ein Baseline-Bump ankert die `d-check:cite`-Spannen neu (Nachtrag zu [MR-021](#mr-021)) | `d-check:cite`-Direktiven auf `.harness/baseline/<tag>/` in lebenden Dokumenten — die Feld-Aussage, in den eingefrorenen Verzeichnissen stehe keine, ist durch [MR-054](#mr-054) überholt | keine — Nachtrag zu [`MR-021`](conventions.md#mr-021); der Kanon kennt keine Zeilen-Anker, weil er kein Werkzeug voraussetzt, das sie prüft |
| [MR-052](conventions/MR-052-historisches-zitat-ist-pruefbar.md) <a id="mr-052--ein-historisches-baseline-zitat-ist-prüfbar-der-alte-baum-liegt-in-der-git-historie-schärft-mr-039"></a><a id="mr-052"></a> | Ein historisches Baseline-Zitat ist prüfbar: der alte Baum liegt in der git-Historie (schärft [MR-039](#mr-039)) | wörtliche Baseline-Zitate auf einen **früheren** Pin in lebenden Dokumenten | keine — Schärfung von [`MR-039`](conventions.md#mr-039); der Kanon stellt die Wörtlichkeits-Frage nicht |
| [MR-053](conventions/MR-053-dritte-vorpruefung-nachtlauf.md) <a id="mr-053--die-slice-planung-trägt-eine-dritte-vorprüfung-den-nachtlauf-stand"></a><a id="mr-053"></a> | Die Slice-Planung trägt eine dritte Vorprüfung: den Nachtlauf-Stand | jeder neue Slice-Plan, im Abschnitt der vorgelagerten Prüfungen (kein Retrofit) | ergänzt die **zwei** Blöcke der Baseline-`slice.template.md` — der Kanon kennt keinen Nachtlauf |
| [MR-054](conventions/MR-054-vorpruefungen-belegen-ihre-regel.md) <a id="mr-054--slice-vorprüfungen-belegen-ihre-regel-mit-d-checkcite"></a><a id="mr-054"></a> | Slice-Vorprüfungen belegen ihre Regel mit `d-check:cite` (Nachtrag zu [MR-051](#mr-051)) | die beiden **kanonischen** Vorprüfungs-Blöcke jedes neu angelegten Slice-Plans — nicht der dritte (Nachtlauf), nicht rückwirkend | keine — der Kanon verlangt die beiden Schritte, sagt aber nichts darüber, **wie** ihre Ausführung belegt wird |
...
| [MR-072](conventions/MR-072-baseline-v690.md) <a id="mr-072--baseline-pin-hebung-auf-v690-vierzehnter-nachtrag-zu-mr-011-nachtrag-zu-mr-023"></a><a id="mr-072"></a> | Baseline-Pin-Hebung auf v6.9.0 (vierzehnter Nachtrag zu [MR-011](#mr-011), Nachtrag zu [MR-023](#mr-023)) | §Baseline, pin-gebundene Verweise, `.harness/baseline/v6.9.0/` | — *(Pin-Fortschreibung im Bundle-Layout des Vorgängers)* |
...
| [MR-065](conventions/done/MR-065-baseline-v631.md) <a id="mr-065--baseline-pin-hebung-auf-v631-elfter-nachtrag-zu-mr-011-nachtrag-zu-mr-023"></a><a id="mr-065"></a> | [MR-067](#mr-067) (nächste Pin-Hebung — der eigene Auflösungs-Trigger des Eintrags) |
...
| [MR-063](conventions/done/MR-063-eigenstaendiger-review-archiv-move.md) <a id="mr-063--eigenständiger-review-archiv-move-ist-ein-einziger-deklarierter-commit-nachtrag-zu-mr-013"></a><a id="mr-063"></a> | Baseline-Konformität (seit slice-223), wie [MR-059](#mr-059) |
| [MR-064](conventions/done/MR-064-buendelung-slice-archiv-move.md) <a id="mr-064--bündelung-mehrerer-einzel-slice-archiv-moves-in-einem-commit-ist-zulässig-nachtrag-zu-mr-062"></a><a id="mr-064"></a> | Baseline-Konformität (seit slice-223), wie [MR-062](#mr-062) |
