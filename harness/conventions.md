...
| [MR-061](conventions/MR-061-register-migrations-move.md) <a id="mr-061--register-formatmigration-ist-ein-einziger-deklarierter-commit-nachtrag-zu-mr-013"></a><a id="mr-061"></a> | Register-Formatmigration (Beobachtungs-Register Tabelle → Verzeichnis) ist ein einziger, deklarierter Commit — korrigiert eine fehlgeschlagene [MR-059](#mr-059)-Analogie in der Commit-Botschaft von slice-195 | genau der eine Migrations-Commit von [slice-195](../docs/plan/planning/in-progress/slice-195-beobachtungsregister-migration.md); erschöpft, keine Blankovollmacht | keine — Nachtrag zu [MR-013](#mr-013) |
