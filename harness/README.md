...
| [`make mention-coverage`](sensors/mention-coverage.md) | hält, dass jedes Artefakt einer konfigurierten Menge in der Ist-Doku vorkommt | [ADR-0084](../docs/plan/adr/0084-mentions-eigenes-modul.md); [`DC-FA-MENT-001`](../spec/lastenheft.md#dc-fa-ment-001--erwähnungs-deckung-einer-artefakt-menge-modul-mentions-opt-in) |
