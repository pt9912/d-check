...
| [`make image-scan`](sensors/image-scan.md) | CVE-Scan gegen die publizierten Images, nicht gegen den Arbeitsbaum |
...
| [`make workflow-pins`](sensors/workflow-pins.md) | hält die Deklarations-Form aller `uses:`-Referenzen in den Workflows |
