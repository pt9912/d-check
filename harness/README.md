...
| `make coverage-gate` | Gesamt-Coverage über `./internal/...` (`-coverpkg` über Paketgrenzen, Dockerfile-Stage + `tools/coverage-gate.sh`) | Kalibrierungs-Bindung: Schwelle 90 % seit welle-03 done (Ramp 85 % → 90 % vollzogen, slice-009); Verfehlung ⇒ Carveout-Pflicht (Kurs-Modul 13); Senkung nur per ADR (`AGENTS.md` §3.6) |
