...
| `make coverage-gate` | Gesamt-Coverage über `./internal/...` (`-coverpkg` über Paketgrenzen, Dockerfile-Stage + `tools/coverage-gate.sh`) | Kalibrierungs-Bindung: Schwelle 85 %, welle-03 done → 90 %; Verfehlung nach Trigger ⇒ Carveout-Pflicht (Kurs-Modul 13); Senkung nur per ADR (`AGENTS.md` §3.6) |
