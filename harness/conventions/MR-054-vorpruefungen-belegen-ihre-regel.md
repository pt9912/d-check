...
- **Ersetzt-Baseline-Regel:** keine. Der Kanon verlangt die beiden
  ...
  ([`modul-05-planning-harness.md` §Zwei Schritte vor der Modus-Begründung](../../.harness/baseline/v6.9.0/regelwerk/modul-05-planning-harness.md#zwei-schritte-vor-der-modus-begründung)),
