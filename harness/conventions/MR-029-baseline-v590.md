...
- **Adaption:** Der Baseline-Pin ist von `v5.7.0` auf **`v5.9.0`** gehoben
  ...
  **Das Delta sind zwei Stufen, gemessen statt gezählt:** 33 Bundle-Dateien
  unterscheiden sich, **26 davon nur im Quell-URL-Stempel** ihrer Kopfzeile.
  Inhaltlich ändern sich vier Regelwerks-Dateien (`grundlagen-harness-dateien`
  +34/−1, `modul-03-spec` +11, `modul-06-roadmap` +5/−5, der Index) und sieben
  Templates — und alle tragen **eine** Regel: ein Feld, das einen *Zustand*
  ...
  - **Alter Baum entfernt, Historie via Tombstone.** `.harness/baseline/v5.9.0/`
