...
- **Status:** Accepted
- **Ersetzt-Baseline-Regel:** [`grundlagen-harness-dateien.md` §Verzeichniskonvention](../../.harness/baseline/v6.5.0/regelwerk/grundlagen-harness-dateien.md#verzeichniskonvention)
- **Datum:** 2026-06-26
...
- **Adaption:** Seit
  ...
  bleiben). Diese Links tragen den **konkreten** Pin (aktuell `…/v6.5.0/…`), nicht
