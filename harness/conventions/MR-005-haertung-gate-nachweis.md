...
- **Status:** Accepted
- **Datum:** 2026-06-10
- **Ersetzt-Baseline-Regel:** [`grundlagen-durchsetzungsschicht.md` §Vier Design-Eigenschaften](../../.harness/baseline/v5.18.0/regelwerk/grundlagen-durchsetzungsschicht.md#vier-design-eigenschaften)
...
- **Adaption:** Zwei Abweichungen von der per
  ...
  untracked Dateiinhalte) statt diff-basiert — genau die Design-Eigenschaft   <!-- d-check:cite .harness/baseline/v5.18.0/regelwerk/grundlagen-durchsetzungsschicht.md:50-50 -->
