...
- **Ersetzt-Baseline-Regel:** keine. Der Kanon macht die DoD-Häkchen zur
  **Bedingung des Übergangs** und sagt das wörtlich:   <!-- d-check:cite .harness/baseline/v6.3.1/regelwerk/modul-05-planning-harness.md:33-34 -->
  „DoD-Häkchen und Closure-Notiz
  sind die Bedingung dafür, dass die Datei überhaupt nach `done/` darf."
  ([`modul-05-planning-harness.md`](../../.harness/baseline/v6.3.1/regelwerk/modul-05-planning-harness.md)).
