...
- **Ersetzt-Baseline-Regel:** keine. Der Kanon gibt das **Prinzip** und lässt
  ...
  [`modul-02-harness-bootstrap.md` §Freshness-Audit](../../.harness/baseline/v6.5.0/regelwerk/modul-02-harness-bootstrap.md#freshness-audit-der-vendored-baseline-schritt-2)   <!-- d-check:cite .harness/baseline/v6.5.0/regelwerk/modul-02-harness-bootstrap.md:283-284 -->
