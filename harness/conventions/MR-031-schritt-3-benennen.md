...
- **Status:** Accepted
- **Ersetzt-Baseline-Regel:** [`modul-09-implementierung.md`](../../.harness/baseline/v6.0.0/regelwerk/modul-09-implementierung.md)   <!-- d-check:cite .harness/baseline/v6.0.0/regelwerk/modul-09-implementierung.md:20-20 -->
...
- **Adaption:** Schritt 3 verlangt hier zusätzlich, das Ergebnis **zu
  ...
  **Was die Verschärfung trägt:** Der Kanon nennt die *minimalen Eingaben eines
  Implementer-Agenten gegen Halluzination* und stellt fest, dass fehlende   <!-- d-check:cite .harness/baseline/v6.0.0/regelwerk/modul-09-implementierung.md:166-166 -->
  Eingaben *„durch Raten ersetzt"* werden. Er verlangt in Schritt 8 den Bericht
  über **gelaufene** Sensors, aber nirgends die **Vorab-Nennung** der Gates,   <!-- d-check:cite .harness/baseline/v6.0.0/regelwerk/grundlagen-harness-dateien.md:187-187 -->
  ...
  *halb durchgesetzt*
  ([`modul-09`](../../.harness/baseline/v6.0.0/regelwerk/modul-09-implementierung.md)
