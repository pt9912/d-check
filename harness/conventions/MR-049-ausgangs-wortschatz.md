...
- **Ersetzt-Baseline-Regel:** keine. Der Kanon benennt die urteilsfreie Hälfte
  der Drei-Ausgänge-Regel ausdrücklich — *dass* zu jedem Risiko ein Ausgang   <!-- d-check:cite .harness/baseline/v6.3.1/regelwerk/modul-05-planning-harness.md:156-157 -->
...
- **Grenzen — gemessen, nicht geschätzt.**
  ...
  **Drei Formen sieht die Regel nicht.** Ein Risiko **ganz ohne** Marker liefert
  ...
  `slice-110` und `slice-111`, deren §5 Risiken führt und keinen einzigen   <!-- d-check:cite .harness/baseline/v6.3.1/regelwerk/modul-05-planning-harness.md:146-146 -->
