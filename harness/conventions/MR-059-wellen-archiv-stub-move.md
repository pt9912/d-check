...
- **Adaption:** Ein Slice- oder Welle-Stub **ersetzt** den Volltext durch
  einen komplett neuen, templatierten Text ([`archiv-stub-slice.template.md`](../../.harness/baseline/v6.6.0/templates/docs/plan/planning/archiv-stub-slice.template.md)) —
