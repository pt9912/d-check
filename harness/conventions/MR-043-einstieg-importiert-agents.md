...
- **Ersetzt-Baseline-Regel:** keine. Der Kanon verlangt von der
  ...
  [`grundlagen-durchsetzungsschicht.md` §Das vollständige Artefakt-Set](../../.harness/baseline/v6.5.0/regelwerk/grundlagen-durchsetzungsschicht.md):   <!-- d-check:cite .harness/baseline/v6.5.0/regelwerk/grundlagen-durchsetzungsschicht.md:100-102 -->
