...
- **Ersetzt-Baseline-Regel:**
  [`grundlagen-harness-dateien.md` §harness/README.md als Einstiegspunkt](../../.harness/baseline/v6.9.0/regelwerk/grundlagen-harness-dateien.md#harnessreadmemd-als-einstiegspunkt) (Absatz *„Ein einfrierendes Artefakt nennt ein prozess-bewegtes bei seiner Kennung"* — eine Fett-Zeile, keine Überschrift, deshalb der Abschnitts-Anker)
