...
- **Ersetzt-Baseline-Regel:** keine. Der Kanon verlangt für die
  ...
  ([`modul-13-quality-gates.md` §Guard-Härtung](../../.harness/baseline/v6.9.0/regelwerk/modul-13-quality-gates.md))
  und beschreibt den Befehls-Guard als Artefakt
  ([`grundlagen-durchsetzungsschicht.md` §Das vollständige Artefakt-Set](../../.harness/baseline/v6.9.0/regelwerk/grundlagen-durchsetzungsschicht.md)).
