...
- **Ersetzt-Baseline-Regel:** keine — der Eintrag **ergänzt** die Baseline um
  ...
  [`grundlagen-harness-dateien.md` §harness/README.md als Einstiegspunkt](../../.harness/baseline/v6.9.0/regelwerk/grundlagen-harness-dateien.md#harnessreadmemd-als-einstiegspunkt)
  ...
  [slice-209](../../docs/plan/planning/done/wellenlos/slice-209-frozen-klassen-vor-mechanischer-ersetzung.md)
