...
- **Ersetzt-Baseline-Regel:** keine. Der Kanon kennt den ausgehenden Change
  ...
  ([`grundlagen-harness-dateien.md` §Konventionsspeicher](../../.harness/baseline/v6.3.1/regelwerk/grundlagen-harness-dateien.md#harnessconventionsmd-als-konventionsspeicher)).
- **Datum:** 2026-08-26
