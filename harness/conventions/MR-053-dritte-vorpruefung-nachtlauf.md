...
- **Datum:** 2026-08-27
- **Geltungsbereich:** jeder Slice-Plan dieses Repos, im Abschnitt der **vorgelagerten Prüfungen** (Baseline-Form `v6.9.0`: §8 *Sub-Area-Prüfungen und Modus-Begründung*, unbedingter Kopf; Haus-Form des eingefrorenen Bestands: §7 *Vorgelagert*). Der Block
