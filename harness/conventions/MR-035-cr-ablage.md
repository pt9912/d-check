...
- **Status:** Accepted
- **Ersetzt-Baseline-Regel:** keine. Der Kanon kennt genau **einen** Change   <!-- d-check:cite .harness/baseline/v6.6.0/regelwerk/grundlagen-begriffe.md:48-48 -->
  ...
  ([`grundlagen-begriffe.md`](../../.harness/baseline/v6.6.0/regelwerk/grundlagen-begriffe.md)).
  ...
  ([`grundlagen-harness-dateien.md` §Konventionsspeicher](../../.harness/baseline/v6.6.0/regelwerk/grundlagen-harness-dateien.md)).
- **Datum:** 2026-08-25
