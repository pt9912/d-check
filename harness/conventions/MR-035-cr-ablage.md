...
- **Status:** Accepted
- **Ersetzt-Baseline-Regel:** keine. Der Kanon kennt genau **einen** Change   <!-- d-check:cite .harness/baseline/v6.3.1/regelwerk/grundlagen-begriffe.md:47-47 -->
  ...
  ([`grundlagen-begriffe.md`](../../.harness/baseline/v6.3.1/regelwerk/grundlagen-begriffe.md)).
  ...
  ([`grundlagen-harness-dateien.md` §Konventionsspeicher](../../.harness/baseline/v6.3.1/regelwerk/grundlagen-harness-dateien.md)).
- **Datum:** 2026-08-25
