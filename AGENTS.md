...
| `make planning-check`        | Meta-Gate: Roadmap §Aktuelle Welle ↔ `in-progress/slice-*` (Planning-Drift-Schutz) ([slice-040](docs/plan/planning/in-progress/slice-040-planning-consistency-gate.md))                                                                            |
