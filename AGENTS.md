...
[`modul-09-implementierung.md` §AGENTS.md-Regeln](.harness/baseline/v6.0.0/regelwerk/modul-09-implementierung.md#agentsmd-regeln-modul-9)).
...
Grenze** ([Baseline §Was ein Kommentar trägt](.harness/baseline/v6.0.0/regelwerk/grundlagen-harness-dateien.md#was-ein-kommentar-trägt--code-konfiguration-skripte)).
...
**widerspricht**. Kanon:
[Baseline §Was ein Kommentar trägt](.harness/baseline/v6.0.0/regelwerk/grundlagen-harness-dateien.md#was-ein-kommentar-trägt--code-konfiguration-skripte).
...
- Neue oder geänderte `DC-*`-Anforderungen entstehen nur in
  ...
  ([`modul-03-spec`](.harness/baseline/v6.0.0/regelwerk/modul-03-spec.md)); das
